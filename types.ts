...
export type SaleStatus = 'In attesa' | 'Confermato' | 'Annullato' | 'Cancellato' | 'Spedito' | 'Svincolato' | 'Consegnato' | 'Duplicato' | 'Non raggiungibile' | 'Non ritirato' | 'Test' | 'Contattato' | 'Giacenza';
