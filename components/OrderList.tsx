...
const SubIdGroup: React.FC<{
    ...
    onMouseDown: (e: React.MouseEvent, columnKey: string) => void;
}> = ({ group, onViewOrder, getStatusBadge, formatDate, groupedColumnWidths, groupedColumnDefaults, onMouseDown }) => {
...
const OrderList: React.FC<OrderListProps> = ({ sales, onViewOrder, onContactCustomer, onManageOrder, user, affiliates, onOpenWhatsAppTemplateEditor, onRefreshData, onShipOrder, onUpdateSaleStatus }) => {
