...
const ProductDetail: React.FC<ProductDetailProps> = ({ product, userRole, affiliates, sales, currentAffiliate, onBack, onEdit, platformSettings }) => {
  ...
  const canSeeFullBundleDetails = isManagerOrAdmin || userRole === UserRole.LOGISTICS || userRole === UserRole.CUSTOMER_CARE;
                ...
                {activeTab === 'details' && (
                    <div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            ...
                            {canSeeStock && (
                                <div>
                                    <span className="font-semibold text-gray-500">Quantità a Magazzino:</span>
